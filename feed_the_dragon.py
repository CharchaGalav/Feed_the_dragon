...
background = pygame.image.load('D:/Feed_the_dragon/feed_the_dragon/data/dragon_night.jpg')
background_rect = background.get_rect()
background_rect.topleft = (0, 0)

# setup the actors
coin = pygame.image.load('D:/Feed_the_dragon/feed_the_dragon/data/coin.png')
coin_rect = coin.get_rect()
coin_rect.left = BUFFER_DISTANCE
coin_rect.top = random.randint(64, WINDOW_HEIGHT - 64)

dragon = pygame.image.load('D:/Feed_the_dragon/feed_the_dragon/data/dragon.png')
dragon_rect = dragon.get_rect()
dragon_rect.centery = WINDOW_HEIGHT // 2
dragon_rect.right = WINDOW_WIDTH - 10

# setup the sound and music
pickup = pygame.mixer.Sound('D:/Feed_the_dragon/feed_the_dragon/data/pickup.wav')
loss = pygame.mixer.Sound('D:/Feed_the_dragon/feed_the_dragon/data/loss.wav')

pygame.mixer.music.load('D:/Feed_the_dragon/feed_the_dragon/data/background_music.mp3')
...
# font
game_font = pygame.font.Font('D:/Feed_the_dragon/feed_the_dragon/data/AttackGraffiti.ttf', 32)  # fontname, fontsize

# texts
lives = game_font.render('Lives : ' + str(current_player_lives), True,
                         GREEN)  # True -> anti-aliasing means smooth edges of text
